...
const Signup = () => {
  return (
    ...
    <input className="border-2 p-3 " placeholder="Enter your Name "/>
 ...
 className="h-1 w-full"/></h1>
       ...
       <h1 className="text-center">Already have an account <Link to="/login"
       className="underline text-blue-500">Login</Link></h1>
